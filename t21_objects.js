...
function getUserAge(){
    ...
    if (AGE_FIELD.checkValidity() === false){
        ...
        OUTPUT.innerHTML += "<p>You're " + user.age + "? Wow, that's old! Are you sure you're not immortal?</p>"
    } else {
    OUTPUT.innerHTML += "<p>You are " + user.age + " years old.</p>";
}
  }
